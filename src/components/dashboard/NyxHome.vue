        ...
        <div class="card-body px-3 py-5">
            ...
            <div class="row">
                <div class="col-md-6 text-center align-self-center">
                    ...
                    <button class="btn btn-primary w-50" type="button" :disabled="nyxStore.isConnected" @click="emit('connect')">
                        connect
                    </button>

                    <br /><br />

                    <button class="btn btn-secondary w-50" type="button" :disabled="!nyxStore.isConnected" @click="emit('disconnect')">
                        disconnect
                    </button>
                ...
                <div class="col-md-6 text-center align-self-center">
                    ...
                    <svg class="d-none d-md-inline" xmlns="http://www.w3.org/2000/svg" width="250" height="250" :fill="nyxStore.isConnected ? '#0d6efd' : '#6c757d'" viewBox="0 0 16 16">
